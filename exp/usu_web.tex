...
\expPosTitle{Graduate Student Recruitment Specialist/Webmaster}
\expPosPeriod{Jul 2006 -- Aug 2009} % Remember to use -- between dates
...
\iftoggle{superInfo}{\expExtra{%
  \textit{Supervisor:} Mary Lee Anderson (\href{mailto:marylee@engineering.usu.edu}{marylee@engineering.usu.edu})}}{}
